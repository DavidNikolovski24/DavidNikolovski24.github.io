...
export const metadata: Metadata = {
  ...
  keywords:
    'frontend developer, full-stack developer , web developer, HTML, CSS, React, Next.js, Tailwind CSS, portfolio, street artist, Velnes.mk, Velnes.mk projects, David Nikolovski achievements, web development showcase',
